...
def test_api_key(llm_service: str, api_key: str) -> bool:
    ...
    try:
        if llm_service == "deepseek":
            ...
            # llm = ChatAnthropic(api_key=api_key, model="claude-sonnet-4-20250514", timeout=30)  # Latest Claude Sonnet 4
            llm = ChatAnthropic(
                anthropic_api_url="https://xiaoai.plus",  # Custom API endpoint
